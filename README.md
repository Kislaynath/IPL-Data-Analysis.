...
## 🧠 Overview
This project performs **Exploratory Data Analysis (EDA)** on IPL (Indian Premier League) datasets to uncover trends, insights, and performance metrics using **Python**, **Pandas**, **Matplotlib**, and **Seaborn**.
...
### 👨‍💻 Author
**Kislaynath**  
_Data Analyst & Python Enthusiast_  
